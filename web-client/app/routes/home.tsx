...
export default function Home() {
  return (
    <div className="relative h-screen w-screen bg-[#111111]">
      <div
        className="fixed inset-[1%] rounded-3xl border-2 border-black"
        style={{
          backgroundColor: "#242424",
          backgroundImage:
            "linear-gradient(180deg, #3a3a3a 0%, #313131 10%, #282828 18%, #353535 28%, #242424 38%, #2d2d2d 50%, #202020 62%, #2a2a2a 74%, #1b1b1b 86%, #242424 100%)",
        }}
      />
      <div className="fixed inset-[1%] z-[5] overflow-hidden rounded-3xl">
        <div className="flex h-[60px] w-full items-center justify-between bg-[#252525] px-[31px]">
          ...
          <Button
            asChild
            className="mr-[3px] h-9 rounded-lg border border-white/12 bg-[#3a3a3a] px-[19px] text-sm font-bold text-white hover:bg-[#444444]"
          >
            <Link to="/dashboard">
              <svg
                aria-hidden="true"
      ...
      <div className="pointer-events-none fixed inset-[1%] z-20 flex items-center justify-center p-6">
        <div className="pointer-events-auto flex w-full max-w-xl flex-col items-center text-center">
          ...
          <div className="mt-8 flex w-full max-w-md flex-col gap-3">
            ...
            <Button
              asChild
              className="h-12 w-full rounded-xl border border-black bg-white text-base font-black text-black hover:bg-[#eaeaea]"
            >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none fixed inset-[1%] z-10 -translate-x-px -translate-y-px rounded-3xl border-[5px] border-[#02faf2]/70 bg-transparent"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none fixed inset-[1%] z-10 translate-x-[2px] translate-y-[2px] rounded-3xl border-[5px] border-[#ed64fa]/70 bg-transparent"
      />
    </div>
  )
}
